...
const EditEmployee = ({name,role,EditEmployeez,id}) => {

    const [namez, setNamez] = useState(name);
    const [rolez, setRolez] = useState(role);
...
<button  onClick={handleShow} className="px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">Edit Now</button>
  ...
  <div className="md:flex md:items-center mb-6">
    ...
    <div className="md:w-2/3">
      ...
      <button form ="editmodal" className="shadow bg-purple-600 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" >
        Update
      </button>
            </Modal.Footer>
          </Modal>
